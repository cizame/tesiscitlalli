...
La cantidad de vertices que estos arboles tienen, se usa como cota
inferior, para la cantidad de vertices que una $(3,g)$-jaula pudiera tener.
...
dos y cuatro, entonces la arista faltante a $g$  tiene un vertice en la rama
tres. Si $g$ es adyacente a $j$, se forma el ciclo de longitud seis de
la figura~\ref{ciclo(3,8)2}, entonces $g$ es adyacente a $l$. La
subgrafica de $G$ que hasta el momento esta formada es la representada
