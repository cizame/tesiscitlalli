...
El corolario~\ref{cardinespar} dice que la cardinalidad de vértices de
una grafica regular no
puede ser impar. Entonces el siguiente caso a considerar es una gráfica
de veinticuatro vértices, veintidós en el árbol y dos fuera de él,
