...
\begin{proposition}\textbf{}\\
  Si existe un $uv$-camino en una gráfica $G$, entonces también existe un $vu$-camino. Más aún la
...
en $G$, entonces $\{v=t_n,...,t_1,t_0=u \}$ es un $vu$-camino. Por lo tanto, si existe un $uv$-camino siempre va a existir un $vu$-camino.
...
\begin{demostration} Se demostrará por contradicción. Suponga que existe una gráfica $G$, tal que la vecindad de cualquiera de sus vértices es isomorfa a $P_2$. 
...
Demostración: Se demostrará que si $G$ es bipartita entonces no
