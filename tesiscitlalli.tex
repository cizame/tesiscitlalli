...
$(23...n1)$ es la permutaci\'on $\sigma$.
...
\end{theorem}
\begin{demostration}
La demostración del teorema~\ref{teonodemos} se encuentra en \cite{Barrera}, p\'agina 24; o en \cite{Ehrlich}, p\'agina 44.
\end{demostration}

\begin{theorem}
Sea $G$ un grupo. La intersecci\'on de subgrupos de $G$ es también un subgrupo. 
\end{theorem}

\begin{demostration}
Sea $I$ un conjunto de subgrupos de $G$. 

Primero; cada $H\in I$ contiene la identidad, $e$, de $G$. Se tiene $e\in \bigcap_{H\in I}H$, entonces $\bigcap_{H\in I}H\neq \phi$.

Ahora suponga que $a,b\in \bigcap_{H\in I}H$. Entonces $a,b\in H$, para cada $H\in I$. Por el teorema~\ref{teonodemos} se tiene $ab^{-1}\in H$, para cada $H\in I$, de lo que se sigue $ab^{-1}\in \bigcap_{H\in I}H$. Por lo tanto $\bigcap_{H\in I}H\le G$.
\end{demostration}

\begin{definition}\textbf{Subgrupo generado por un conjunto}\\\index{Subgrupo generado}
Sean $G$ un grupo y $S$ un conjunto no vacío de $G$. Entonces el subgrupo de $G$ generado por $S$ es:
\begin{equation*}
...
para fines de esta tesis s\'olo se consideran \'este tipo de grupos, a los
...
\begin{definition}\textbf{Orden de un elemento}\\\index{Orden de un elemento del grupo}
  ...
  positivo $n$ tal que $g^n=e$ y se denotar\'a por $|g|=n$.\index{$|g|$}
\end{definition}
...
\begin{demostration} Para que la acci\'on sea regular se deben probar tres cosas:
...
este resultado no ser\'a demostrado.
