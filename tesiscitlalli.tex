...
costruir graficas 3-regulares que padrian tener menos vertices, que
...
elementos del conujunto $T$, basta dar condiciones sobre el conjunto para que
la gráfica lo sea, pues de otro modo, la bipartita clánica no sería
...
$3K_2$, la primera condición que es evidente, es el echo de que la
cardinalidad del conjunto $T$ debe ser 6. Continuando con el análisis, sean $a, b \in T$ tal que $a
\sim b$.
